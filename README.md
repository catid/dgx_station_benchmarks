...
| [DeepSeek-V4.1-Flash](deepseek-v4.1-flash/) | Official native FP8-dense/FP4-expert checkpoint; 2× DGX Station only: SGLang TP2+EP2 and vLLM PP2/TP2 (DSpark) over Data Direct RDMA (1× not attempted) | Prefill: vLLM PP2 55,992 prompt tok/s for one 128K request, 65,966 aggregate at 64K C16; SGLang +SWA replay 39,549 for one 16K request, 37,693 aggregate at 128K C16 (exact full prefill 26,316 / 24,419); decode: vLLM TP2 DSpark 201.0 output tok/s per user at C1 and 3,401.6 aggregate at C64; SGLang DSpark C1 180.0 output tok/s |
