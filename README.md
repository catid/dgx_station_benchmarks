...
| --- | --- | --- |
| [Qwen3.8-Flash-Next](qwen3.8-flash-next/) | local-inference-lab NVFP4-4p89/SGLang on 2× DGX Station GB300; 4× RTX PRO 6000 comparison | TP2/AR: 142.4 tok/s C1; 3,055.9 C64 |
