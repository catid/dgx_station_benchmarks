...
| --- | --- | --- |
| [Qwen3.8-Flash-Next](qwen3.8-flash-next/) | local-inference-lab NVFP4-4p89/SGLang on 2× DGX Station GB300; 4× RTX PRO 6000 comparison | TEP2/MTP3: 246.4 tok/s C1; TEP2/AR: 3,164.1 C64 |
