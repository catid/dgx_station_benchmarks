...
| --- | --- | --- |
| [Qwen3.8-Flash-Next](qwen3.8-flash-next/) | local-inference-lab NVFP4-4p89/SGLang on 1× or 2× DGX Station GB300; 4× RTX PRO 6000 comparison | 1× TP1/AR: 202.1 tok/s C1, 4,090.4 C64, 38,653 tok/s 64K prefill |
