...
resolve_plan_env() {
  ...
  export MOE_BACKEND FLASHINFER_AUTOTUNE MTP_TOKENS MTP_DRAFT_MOE_BACKEND
  export VLLM_USE_V2_MODEL_RUNNER CUDAGRAPH_CAPTURE_SIZES
  export CUDAGRAPH_MODE MAX_CUDAGRAPH_CAPTURE_SIZE BLOCK_SIZE ENFORCE_EAGER
  export PREHEADLINE_CORRECTNESS_GATE GATE_PROMPT_TOKENS GATE_OUTPUT_TOKENS
  export CACHE_PROFILE_ID KV_CACHE_DTYPE
