...
structurally accepted PP2 request-bearing increment, but it is a decode-
performance failure at 13.5–58.9% of P0 across C1–C128 and is not recommended
for serving. Its record includes the P0-versus-P10 configuration comparison,
retained quality, network, capacity, and startup evidence. P11–P13 add a
one-knob TP2 prefill sweep at fixed 4K, 8K, and 16K maximum batched-token
chunks, compared with the frozen P0 32K control. The new arms are prefill-only
and publish request/cache sanity rather than new retained semantic-quality
results.
