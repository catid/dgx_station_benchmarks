...
- `dgx-nvfp4-decode.png` shows the two-Station TP2/TEP2 NVFP4 decode lanes
  through C64 with the 4× RTX PRO 6000 comparison.
...
Every DGX curve is one distributed engine across both Stations. Detailed run
and source notes are in [`../recipes/`](../recipes/).
