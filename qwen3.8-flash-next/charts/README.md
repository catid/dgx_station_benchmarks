...
- `dgx-nvfp4-decode.png` shows one-Station TP1/AR and two-Station TP2/TEP2
  NVFP4 decode through C64, with separate 4× RTX PRO 6000 RadixArk NVFP4
  TEP4/AR and TEP4/MTP3 comparisons.
...
The TP1 curve is one engine on one Station. Each TP2/TEP2 curve is one engine
