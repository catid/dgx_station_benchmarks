...
- `dgx-nvfp4-decode.png` shows one-Station TP1/AR and TP1/MTP3 plus
  two-Station TP2/TEP2 NVFP4 decode through C64, with separate 4× RTX PRO
  6000 RadixArk NVFP4 TEP4/AR and TEP4/MTP3 comparisons.
...
Each TP1 curve is one engine on one Station. Each TP2/TEP2 curve is one engine
across both Stations. Each dashed workstation curve is one TEP4 server across
four GPUs in the labeled decode mode. Detailed run and source notes are in
[`../recipes/`](../recipes/).
